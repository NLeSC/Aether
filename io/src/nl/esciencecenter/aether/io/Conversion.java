/* $Id: Conversion.java 10622 2009-03-18 11:10:27Z ndrost $ */
...
public abstract class Conversion {
    ...
    public static final Conversion loadConversion(boolean bigEndian) {
        ...
        if (conversion != null && conversion.equalsIgnoreCase("wrap")) {
            ...
            try {
                if (bigEndian) {
                    return new nl.esciencecenter.aether.io.nio.NioWrapBigConversion();
                }
                return new nl.esciencecenter.aether.io.nio.NioWrapLittleConversion();
            } catch (Exception e) {
            ...
            try {
                if (bigEndian) {
                    return new nl.esciencecenter.aether.io.nio.NioChunkBigConversion();
                }
                return new nl.esciencecenter.aether.io.nio.NioChunkLittleConversion();
            } catch (Exception e) {
                // nio conversion loading failed
            }
            ...
            try {
                if (bigEndian) {
                    return new nl.esciencecenter.aether.io.nio.HybridChunkBigConversion();
                }
                return new nl.esciencecenter.aether.io.nio.HybridChunkLittleConversion();
            } catch (Exception e) {
