/* $Id: ReadMessage.java 14996 2013-01-21 07:40:26Z ceriel $ */
 ...
 * {@link nl.esciencecenter.aether.ReceivePort receiveport}, either
 * by means of an upcall, or by means of an explicit receive, which is
 * accomplished by call to {@link nl.esciencecenter.aether.ReceivePort#receive() receive}.
 * A {@link nl.esciencecenter.aether.ReceivePort receiveport} can be configured to generate
...
public interface ReadMessage {
    ...
    /**
     * Returns the {@link nl.esciencecenter.aether.ReceivePort receiveport} of this
     * <code>ReadMessage</code>. When {@link #finish()} has been called on the
     * message, this information can no longer be trusted.
     *
     * @return
     *          the {@link nl.esciencecenter.aether.ReceivePort receiveport} of this
    ...
    /**
     * Returns the {@link nl.esciencecenter.aether.SendPortIdentifier sendport identifier}
