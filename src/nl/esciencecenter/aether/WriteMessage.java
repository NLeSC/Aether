/* $Id: WriteMessage.java 14996 2013-01-21 07:40:26Z ceriel $ */
...
public interface WriteMessage {
    ...
    /**
     * Starts sending the message to all {@link nl.esciencecenter.aether.ReceivePort
     * ReceivePorts} its {@link nl.esciencecenter.aether.SendPort} is connected to.
     * Data may be streamed, so the user is not allowed to change the data
