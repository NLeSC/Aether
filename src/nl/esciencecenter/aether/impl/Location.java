/* $Id: Location.java 13246 2011-04-13 13:14:28Z ceriel $ */
 ...
 */
public final class Location implements nl.esciencecenter.aether.Location {
    ...
    public int numberOfMatchingLevels(nl.esciencecenter.aether.Location o) {
    ...
    public boolean equals(Object o) {
        if (! (o instanceof nl.esciencecenter.aether.impl.Location)) {
            return false;
        }
    ...
    public int compareTo(nl.esciencecenter.aether.Location o) {
    ...
    public nl.esciencecenter.aether.Location getParent() {
        if (parent == null) {            
