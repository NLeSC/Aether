/* $Id: ReceivePortConnectionInfo.java 15123 2013-07-02 13:40:20Z ceriel $ */

package nl.esciencecenter.aether.impl;

import java.io.IOException;

import nl.esciencecenter.aether.io.DataInputStream;
...
/**
 * This class represents the information about a particular sendport/receiveport connection, on the receiver side.
 */
public class ReceivePortConnectionInfo {

    /** Debugging. */
    protected static final Logger logger = LoggerFactory.getLogger("ibis.ipl.impl.ReceivePortConnectionInfo");
    ...
    /**
     * The underlying data stream for this connection. The serialization stream lies on top of this.
     */
    ...
    /**
     * Constructs a new <code>ReceivePortConnectionInfo</code> with the specified parameters.
     * 
     * @param origin
     *            identifies the sendport of this connection.
     * @param port
     *            the receiveport.
     * @param dataIn
     *            the inputstream on which a serialization input stream can be built.
    ...
    /**
     * This method must be called each time a connected sendport adds a new connection. This new connection may either be to the
     * current receiveport, or to another one. In both cases, the serialization stream must be recreated.
     * 
     * @exception IOException
     *                is thrown in case of trouble.
     */
    ...
    /**
     * This method closes the connection, as the result of the specified exception. Implementations may need to redefine this
     * method
     * 
     * @param e
     *            the exception.
    ...
    /**
     * This method gets called when the upcall for the message explicitly called {@link ReadMessage#finish()}. The default
     * implementation just allocates a new message.
     */
