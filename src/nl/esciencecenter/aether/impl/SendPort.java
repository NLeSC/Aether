/* $Id: SendPort.java 15123 2013-07-02 13:40:20Z ceriel $ */
...
import nl.esciencecenter.aether.io.Replacer;
...
/**
 * Implementation of the {@link nl.esciencecenter.aether.SendPort} interface, to be extended
 * by specific Ibis implementations.
 */
public abstract class SendPort extends Manageable implements nl.esciencecenter.aether.SendPort {
    ...
    public synchronized nl.esciencecenter.aether.ReceivePortIdentifier[] lostConnections() {
        ...
        nl.esciencecenter.aether.ReceivePortIdentifier[] result = lostConnections.toArray(
                new nl.esciencecenter.aether.ReceivePortIdentifier[lostConnections.size()]);
    ...
    public nl.esciencecenter.aether.SendPortIdentifier identifier() {
        return ident;
    }

    public void connect(nl.esciencecenter.aether.ReceivePortIdentifier receiver)
    ...
    public synchronized void connect(nl.esciencecenter.aether.ReceivePortIdentifier receiver,
    ...
    public nl.esciencecenter.aether.ReceivePortIdentifier[] connect(
        ...
        nl.esciencecenter.aether.ReceivePortIdentifier [] ids = 
            new nl.esciencecenter.aether.ReceivePortIdentifier[ports.size()];
    ...
    public void connect(nl.esciencecenter.aether.ReceivePortIdentifier[] ports)
            throws ConnectionsFailedException {
        connect(ports, 0, true);
    }

    public synchronized void connect(nl.esciencecenter.aether.ReceivePortIdentifier[] ports,
            long timeout, boolean fillTimeout) throws ConnectionsFailedException {

        ArrayList<nl.esciencecenter.aether.ReceivePortIdentifier> succes
            = new ArrayList<nl.esciencecenter.aether.ReceivePortIdentifier>();

        LinkedList<nl.esciencecenter.aether.ReceivePortIdentifier> todo
            = new LinkedList<nl.esciencecenter.aether.ReceivePortIdentifier>();
        
        HashMap<nl.esciencecenter.aether.ReceivePortIdentifier, Throwable> results 
            = new HashMap<nl.esciencecenter.aether.ReceivePortIdentifier, Throwable>();
        ...
        for (nl.esciencecenter.aether.ReceivePortIdentifier rp : ports) {
            todo.add(rp);
        }
        ...
        while (todo.size() > 0) { 
            ...
            nl.esciencecenter.aether.ReceivePortIdentifier rp = todo.removeFirst(); 
        ...
        if (succes.size() != ports.length) {
            ...
            for (nl.esciencecenter.aether.ReceivePortIdentifier rp : todo) {
            ...
            ex.setObtainedConnections(succes.toArray(
                    new nl.esciencecenter.aether.ReceivePortIdentifier[succes.size()]));
    ...
    public nl.esciencecenter.aether.WriteMessage newMessage() throws IOException {
    ...
    public synchronized nl.esciencecenter.aether.ReceivePortIdentifier[] connectedTo() {
        return receivers.keySet().toArray(
                new nl.esciencecenter.aether.ReceivePortIdentifier[receivers.size()]);
    }
    ...
    protected void finishMessage(WriteMessage w, long cnt)
            throws IOException {
	nl.esciencecenter.aether.ReceivePortIdentifier[] ports = null;
        try {
            synchronized(this) {
    ...
    /**
     * This method (re-)initializes the {@link nl.esciencecenter.aether.io.DataOutputStream}, and
     ...
     * @param dataOut the {@link nl.esciencecenter.aether.io.DataOutputStream} to be used when
