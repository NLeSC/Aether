...
import nl.esciencecenter.aether.registry.central.EventList;
import nl.esciencecenter.aether.registry.central.ListMemberSet;
import nl.esciencecenter.aether.registry.central.Member;
import nl.esciencecenter.aether.registry.central.MemberSet;
import nl.esciencecenter.aether.registry.central.Protocol;
import nl.esciencecenter.aether.registry.central.TreeMemberSet;
...
final class Pool implements Runnable {
    ...
    synchronized nl.esciencecenter.aether.Location[] getLocations() {
        HashSet<nl.esciencecenter.aether.Location> locations = new HashSet<nl.esciencecenter.aether.Location>();
